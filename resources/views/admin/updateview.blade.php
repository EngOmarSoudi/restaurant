                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{url('/update',$data->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" id="exampleInputName1" value="{{$data->title}}" required>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price" class="form-control" id="exampleInputMobile" value="{{$data->price}}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" class="form-control" id="exampleInputEmail3" value="{{$data->description}}" required>
                                @error('description')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
