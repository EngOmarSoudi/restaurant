                ...
                <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                    ...
                    <ul class="navbar-nav w-100">
                        <li class="nav-item w-100">
                            <form action="{{url('/searchfood')}}" method="get" class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
                                @csrf
                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{url('/uploadfood')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" class="form-control" id="exampleInputMobile" placeholder="price" required>
                                </div>
